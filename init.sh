...
# Compile contract
solc --abi contracts/Maltcoin_temp.sol -o contracts/build
solc --bin contracts/Maltcoin_temp.sol -o contracts/build
...
# Run deployment function and grab information from output
go run $DEPLOY $PRIVKEY > tmp.txt
cat tmp.txt
